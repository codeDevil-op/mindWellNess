...
const Testimonial = () => {
  return (
    <div id='testimonial' className='bg-[#f7f8fc] py-12'>
      ...
      <p className='text-lg mb-12 md:w-1/2 mx-auto'>Hear from some of our satisfied clients about how our services have positively impacted their lives and well-being.</p>
      </div>
